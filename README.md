...
| [6 Render Farm](https://github.com/Azure/ArtistAnywhere/tree/main/6.Render.Farm) | Deploys  [Virtual Machine Scale Sets](https://learn.microsoft.com/azure/virtual-machine-scale-sets/overview)<br/>or [Batch](https://learn.microsoft.com/azure/batch/batch-technical-overview) pools for highly-scalable, custom and intelligent render farms. | Yes, [Azure OpenAI](https://learn.microsoft.com/azure/ai-services/openai/overview) ([DALL-E 3](https://openai.com/dall-e-3)) is optional | Yes, [Azure OpenAI](https://learn.microsoft.com/azure/ai-services/openai/overview) ([DALL-E 3](https://openai.com/dall-e-3)) is optional |

...
| - | - | - | - |
| [0&#160;Global&#160;Foundation](https://github.com/Azure/ArtistAnywhere/0.Global.Foundation) | Defines&#160;global&#160;config&#160;([Azure&#160;region](https://azure.microsoft.com/regions)) and foundation services ([Azure Terraform state storage](https://developer.hashicorp.com/terraform/language/settings/backends/azurerm)). | Yes | Yes |
...
| [6 Render Farm](https://github.com/Azure/ArtistAnywhere/6.Render.Farm) | Deploys  [Virtual Machine Scale Sets](https://learn.microsoft.com/azure/virtual-machine-scale-sets/overview) or [Batch](https://learn.microsoft.com/azure/batch/batch-technical-overview) pools for highly-scalable render farm compute. | Yes, [Azure OpenAI](https://learn.microsoft.com/azure/ai-services/openai/overview) with [DALL-E 2](https://openai.com/dall-e-2) is *optional* | Yes, [Azure OpenAI](https://learn.microsoft.com/azure/ai-services/openai/overview) with [DALL-E 2](https://openai.com/dall-e-2) is *optional* |

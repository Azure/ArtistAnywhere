...
* Clean separation of *configuration* files (**config.auto.tfvars**) and *implementation* files (**\*.tf**) via [Terraform](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs)

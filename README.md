...
| [2 Image](https://github.com/Azure/ArtistAnywhere/tree/main/2.Image) | Deploys [Image Builder](https://learn.microsoft.com/azure/virtual-machines/image-builder-overview) templates and [Compute Gallery](https://learn.microsoft.com/azure/virtual-machines/shared-image-galleries) for x64 and ARM64 images | No, reference your<br/>custom image [here](https://github.com/Azure/ArtistAnywhere/tree/main/6.Compute.Cluster/config.auto.tfvars#L15) | No, reference your<br/>custom image [here](https://github.com/Azure/ArtistAnywhere/tree/main/6.Compute.Cluster/config.auto.tfvars#L15) |

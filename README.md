...
| [2 Image Builder](https://github.com/Azure/ArtistAnywhere/tree/main/2.Image.Builder) | Deploys [Image Builder](https://learn.microsoft.com/azure/virtual-machines/image-builder-overview) and [Compute Gallery](https://learn.microsoft.com/azure/virtual-machines/shared-image-galleries) with [Cosmos (Mongo) DB](https://learn.microsoft.com/azure/cosmos-db/mongodb/introduction). | No, use your custom images via [image.id](https://github.com/Azure/ArtistAnywhere/tree/main/6.Render.Farm/config.vmss.auto.tfvars#L14) | No, use your custom images via [image.id](https://github.com/Azure/ArtistAnywhere/tree/main/6.Render.Farm/config.vmss.auto.tfvars#L14) |

...
| [2 Image Builder](https://github.com/Azure/ArtistAnywhere/tree/main/2.Image.Builder) | Deploys [Compute Gallery](https://learn.microsoft.com/azure/virtual-machines/shared-image-galleries) storage<br/>or [Container Registry](https://learn.microsoft.com/azure/container-registry/container-registry-intro) storage for automated custom image building. | No, use your custom images via [image.id](https://github.com/Azure/ArtistAnywhere/tree/main/6.Render.Farm/config.auto.tfvars#L24) | No, use your custom images via [image.id](https://github.com/Azure/ArtistAnywhere/tree/main/6.Render.Farm/config.auto.tfvars#L24) |
...
1. Review and edit the config values in `config.auto.tfvars` as needed for your target deployment.
   ...
   * For module `6 Render Farm`, review and edit the `module/file.systems.tf` variables file, which is also used by module `7 Artist Workstation`.

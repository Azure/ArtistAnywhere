...
Azure Artist Anywhere (AAA) is a *modular and flexible* [Infrastructure as Code (IaC)](https://learn.microsoft.com/devops/deliver/what-is-infrastructure-as-code) solution deployment framework<br/>for [Azure HPC](https://azure.microsoft.com/solutions/high-performance-computing) & [Azure AI Infrastructure](https://azure.microsoft.com/solutions/high-performance-computing/ai-infrastructure) workloads. Enable remote user productivity with [global Azure scale](https://azure.microsoft.com/global-infrastructure) via AI-enabled [Compute Fleet](https://learn.microsoft.com/azure/azure-compute-fleet/overview) clusters with up to 10,000 [Standard VMs](https://learn.microsoft.com/azure/virtual-machines/overview) & [Spot VMs](https://learn.microsoft.com/azure/virtual-machines/spot-vms) across [multiple regions](https://learn.microsoft.com/azure/azure-compute-fleet/multi-region-compute-fleet) per request.
...
| **Module Name** | **Module Description** | **Required for<br/>Burst Compute<br/>(On-Premises Storage)?** | **Required for<br/>Full Deployment?<br/>(*Compute & Storage*)** |
| - | - | - | - |
...
| [5&#160;Job&#160;Manager](https://github.com/Azure/ArtistAnywhere/tree/main/5.Job.Manager) | Deploys [CycleCloud Workspace for Slurm](https://learn.microsoft.com/azure/cyclecloud/overview-ccws) or job manager [Virtual Machines](https://learn.microsoft.com/azure/virtual-machines) | No | No |

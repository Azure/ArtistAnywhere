...
| [2 Image](https://github.com/Azure/ArtistAnywhere/tree/main/2.Image) | Deploys [Compute Gallery](https://learn.microsoft.com/azure/virtual-machines/shared-image-galleries) and [Image Builder](https://learn.microsoft.com/azure/virtual-machines/image-builder-overview) templates for x64 or ARM64 images | No, reference your<br/>custom image [here](https://github.com/Azure/ArtistAnywhere/tree/main/6.Compute.Cluster/config.auto.tfvars#L15) | No, reference your<br/>custom image [here](https://github.com/Azure/ArtistAnywhere/tree/main/6.Compute.Cluster/config.auto.tfvars#L15) |

...
| **Module Name** | **Module Description** | **Required for Burst Render?<br/>(*Compute Only*)** | **Required for Full Solution?<br/>(*Compute & Storage*)** |
| - | - | - | - |
| [0&#160;Global&#160;Foundation](https://github.com/Azure/ArtistAnywhere/0.Global.Foundation) | Defines global config (default [Azure region](https://azure.microsoft.com/regions)) and foundation services ([Azure Terraform state storage](https://developer.hashicorp.com/terraform/language/settings/backends/azurerm)). | Yes | Yes |
...
| [5 Render Manager](https://github.com/Azure/ArtistAnywhere/5.Render.Manager) | Deploys [Virtual Machines](https://learn.microsoft.com/azure/virtual-machines) for render job scheduling. | No | No |
| [6 Render Farm](https://github.com/Azure/ArtistAnywhere/6.Render.Farm) | Deploys  [Virtual Machine Scale Set](https://learn.microsoft.com/azure/virtual-machine-scale-sets/overview) or [Batch](https://learn.microsoft.com/azure/batch/batch-technical-overview) for highly-scalable render farm compute. | Yes, [Azure OpenAI](https://learn.microsoft.com/azure/ai-services/openai/overview) with [DALL-E 2](https://openai.com/dall-e-2) is *optional* | Yes, [Azure OpenAI](https://learn.microsoft.com/azure/ai-services/openai/overview) with [DALL-E 2](https://openai.com/dall-e-2) is *optional* |
| [7&#160;Artist&#160;Workstation](https://github.com/Azure/ArtistAnywhere/7.Artist.Workstation) | Deploys [Virtual Machines](https://learn.microsoft.com/azure/virtual-machines/overview) for remote artist workstations with [HP Anyware](https://www.teradici.com) access. | No | No |

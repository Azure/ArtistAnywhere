...
az vm image list --publisher $publisher --offer $offer --sku $planController --all # 2024.10.29
az vm image list --publisher $publisher --offer $offer --sku $planNode --all       # 2024.04.2

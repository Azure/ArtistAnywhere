...
resource azurerm_security_center_storage_defender studio {
  ...
  malware_scanning_on_upload_enabled          = module.core.defender.storage.malwareScanning.enable
  malware_scanning_on_upload_cap_gb_per_month = module.core.defender.storage.malwareScanning.maxPerMonthGB
  sensitive_data_discovery_enabled            = module.core.defender.storage.sensitiveDataDiscovery.enable
}

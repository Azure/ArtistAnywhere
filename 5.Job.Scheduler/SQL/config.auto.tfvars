...
mySQL = {
  enable  = false
  name    = "xstudio"
  type    = "MO_Standard_E2ads_v5" # https://learn.microsoft.com/azure/mysql/flexible-server/concepts-service-tiers-storage
  version = "8.0.21"
  delegatedSubnet = {
    enable = true
  }
...
postgreSQL = {
  enable  = false
  name    = "xstudio"
  type    = "MO_Standard_E2ads_v5" # https://learn.microsoft.com/azure/postgresql/flexible-server/concepts-compute
  version = "16"
  delegatedSubnet = {
    enable = true
  }

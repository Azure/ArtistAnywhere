...
$orgUnitPath  = "${activeDirectoryClient.orgUnitPath}"
...
JoinActiveDirectory -domainName $domainName -serverName $serverName -orgUnitPath $orgUnitPath -userName $userName -userPassword $userPassword

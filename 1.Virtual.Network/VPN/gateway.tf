...
resource azurerm_virtual_network_gateway vpn {
  ...
  ip_configuration {
    ...
    public_ip_address_id = "/subscriptions/${data.azurerm_client_config.studio.subscription_id}/resourceGroups/${var.virtualNetwork.vpnGateway.ipAddress1.resourceGroupName}/providers/Microsoft.Network/publicIPAddresses/${var.virtualNetwork.vpnGateway.ipAddress1.name}"
  }
  dynamic ip_configuration {
    ...
    content {
      name                 = "ipConfig2"
      subnet_id            = "/subscriptions/${data.azurerm_client_config.studio.subscription_id}/resourceGroups/${var.virtualNetwork.resourceGroupName}/providers/Microsoft.Network/virtualNetworks/${var.virtualNetwork.name}/subnets/GatewaySubnet"
      public_ip_address_id = "/subscriptions/${data.azurerm_client_config.studio.subscription_id}/resourceGroups/${var.virtualNetwork.vpnGateway.ipAddress2.resourceGroupName}/providers/Microsoft.Network/publicIPAddresses/${var.virtualNetwork.vpnGateway.ipAddress2.name}"
    }
  }
